...
impl InferenceTable {
    ...
    pub(super) fn commit(&mut self, snapshot: InferenceSnapshot) {
    ...
    pub(super) fn normalize_shallow(&mut self, leaf: &Ty) -> Option<Arc<Ty>> {
        leaf.inference_var()
            .and_then(|var| {
