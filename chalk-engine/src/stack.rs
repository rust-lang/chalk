...
use crate::strand::InferringStrand;
...
pub(crate) struct StackEntry<I: Interner> {
    ...
    pub(super) active_strand: Option<InferringStrand<I>>,
}
...
impl<I: Interner> Stack<I> {
    ...
    pub(super) fn pop_and_take_caller_strand(&mut self) -> Option<InferringStrand<I>> {
    ...
    pub(super) fn pop_and_borrow_caller_strand(&mut self) -> Option<&mut InferringStrand<I>> {
        if self.pop_and_adjust_depth() {
