...
macro_rules! ty {
    ...
    (bound $b:expr) => {
        $crate::TyData::BoundVar($crate::DebruijnIndex::from_u32($b)).intern(&chalk_ir::interner::ChalkIr)
    };
...
macro_rules! lifetime {
    ...
    (bound $b:expr) => {
        $crate::LifetimeData::BoundVar($crate::DebruijnIndex::from_u32($b)).intern(&chalk_ir::interner::ChalkIr)
    };
